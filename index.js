                    ...
                    db.query("SELECT * FROM employees", (err, managerResult) => {
                        ...
                        inquirer
                            ...
                            .then(response => {
                                ...
                                db.query("SELECT * FROM departments where departmentsId = ?", response.role .split(" ")[1], (err, result) => {
                                db.query("SELECT * FROM employees WHERE manager_id = ?", response.manager, (err, result) => {
                                db.query("INSERT INTO employees (first_name, last_name, roles_id, manager_id) VALUES (?, ?, ?, ?)", [response.firstname, response.lastname, response.role.split(",")[1], response.manager.split(" ")[0]], (err, result) => {
